...
<p>To reset the password on your account, click the following link and enter your e-mail address: <?php echo $this->Html->link('Reset Password', array('controller' => 'members', 'action' => 'forgot_password', $id, 'full_base' => true)); ?> </p>
