 ...
 */
	public function __construct($request = null, $response = null) {
		...
		$this->__addMainNav('MemberVoice', array( 'plugin' => 'membervoice', 'controller' => 'ideas', 'action' => 'index' ), null, array(Status::CURRENT_MEMBER));
		$this->__addMainNav('Tools', array( 'plugin' => 'tools', 'controller' => 'tools', 'action' => 'index' ), null, array(Status::CURRENT_MEMBER));
	}
